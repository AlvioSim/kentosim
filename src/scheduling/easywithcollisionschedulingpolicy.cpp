 ...
 */
EASYWithCollisionSchedulingPolicy::EASYWithCollisionSchedulingPolicy()
{  
}
 ...
 */
EASYWithCollisionSchedulingPolicy::EASYWithCollisionSchedulingPolicy(ArchitectureConfiguration* architecturedef,Log* log,double globaltime,Backfilling_variant_t backfillingType) : EASYSchedulingPolicy(architecturedef,log,globaltime,backfillingType)
{
 ...
 */
void EASYWithCollisionSchedulingPolicy::allocateJob(Job* job, AnalogicalJobAllocation* allocation)
{
 ...
 */
void EASYWithCollisionSchedulingPolicy::updateTerminationEvents(Job* scheduledJob)
{
  //return;
 ...
 */
void EASYWithCollisionSchedulingPolicy::releaseJobResources(Job* job)
{
 ...
 */
bool EASYWithCollisionSchedulingPolicy::canSatisfyThresholdRestriction(Job* job,double thresshold)
{
...
AnalogicalJobAllocation* EASYWithCollisionSchedulingPolicy::findAllocation(Job* job, double starttime,double runtime)
{
 ...
 */
void EASYWithCollisionSchedulingPolicy::freeAllocation(AnalogicalJobAllocation* allocationForCheckingReq)
{
 ...
 */
void EASYWithCollisionSchedulingPolicy::setJobList(map< int, Job * >* theValue)
{
 ...
 */
void EASYWithCollisionSchedulingPolicy::jobRemoveFromRT(Job* job) //Removes a job from the RT
{
 ...
 */
double EASYWithCollisionSchedulingPolicy::getthresshold() const
{
	return thresshold;
}
 ...
 */
void EASYWithCollisionSchedulingPolicy::setThresshold ( double theValue )
{
 ...
 */
double EASYWithCollisionSchedulingPolicy::getalternativeThreshold() const
{
 ...
 * @param theValue The threshold
 */
void EASYWithCollisionSchedulingPolicy::setAlternativeThreshold ( double theValue )
{
